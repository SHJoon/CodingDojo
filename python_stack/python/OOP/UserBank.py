...
howard = User("Howard", "fsfd@gmail.com")
howard.create_account("Bank of America")
howard.create_account("Chase Bank")
howard.make_deposit("Bank of America", 500)
howard.display_user_balance()
howard.make_deposit("Chase Bank", 750)
howard.make_withdrawl("Bank of America", 600)
howard.create_account("Wells Fargo")
howard.display_user_balance()
